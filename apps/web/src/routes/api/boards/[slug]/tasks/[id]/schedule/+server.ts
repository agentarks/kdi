// KDI-UI-006 single-task schedule. Action is in the URL path; body is the action
...
export const POST: RequestHandler = apiPost(
  (e, body: LifecycleFields) => performTaskAction(e.params.slug, Number(e.params.id), "schedule", body ?? {}),
  200,
);
